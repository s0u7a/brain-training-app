...
> [!IMPORTANT]
> **Backend Migration**: The current `server.js` (Express) cannot run directly on Cloudflare Pages. I will replace it with a `functions/api/tts.js` file that runs on Cloudflare's edge network.
...
#### [NEW] [functions/api/tts.js](file:///home/souta-lab/.gemini/antigravity/brain/ab8bcd2f-736b-47cb-a431-0d8062baabd3/functions/api/tts.js)
- Re-implement the TTS proxy using the standard `fetch` API (compatible with Cloudflare Workers).

#### [DELETE] [server.js](file:///home/souta-lab/.gemini/antigravity/brain/ab8bcd2f-736b-47cb-a431-0d8062baabd3/server.js)
...
#### [NEW] [.github/workflows/deploy.yml](file:///home/souta-lab/.gemini/antigravity/brain/ab8bcd2f-736b-47cb-a431-0d8062baabd3/.github/workflows/deploy.yml)
- GitHub Actions workflow to build and deploy to Cloudflare Pages.

#### [MODIFY] [package.json](file:///home/souta-lab/.gemini/antigravity/brain/ab8bcd2f-736b-47cb-a431-0d8062baabd3/package.json)
